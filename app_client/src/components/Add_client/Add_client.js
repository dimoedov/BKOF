                    ...
                    <div>
                        <form className="form-horizontal" onSubmit={this.handleSubmit}>
                            <div className={`form-group input-group row`}>
                                <label htmlFor="type" className='col-sm-3'>Название компании</label>
                                <input type="text" required className="form-control col-sm-8" name="type"
                                       placeholder="Название компании"
                                       value={this.state.type}
                                       onChange={this.handleUserInput}/>
                            </div>
                            <div className={`form-group input-group row`}>
                                <label htmlFor="name" className='col-sm-3'>ФИО предтставителя </label>
